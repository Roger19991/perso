    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Mes informations a moi</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
        ...
        while($t = mysqli_fetch_assoc($r)){
            ...
            echo "<td>".$t["numero"]."</td>";
            echo "<td>".$t["photo"]."</td>";
            echo "<td>"."<form action='info1.php' method='POST'><input type='text' class='d-none' name='info' value=".$t['id']."><input type='submit' class='btn btn-danger' name='sup' value='supprimer'></form>"."</td>";
            echo "</tr>";
