    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form method="post" action="inser3.php">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text"  name="nom" class="form-control " style="width: 100%;" placeholder="Ce que vous ferez">
                </div>
                <div class="form-group">
                  <label>Date & l'heure:</label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Note</label>
                  <input type="text" name="note" class="form-control " style="width: 100%;" data-inputmask='"mask": " 99/99"' data-mask>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Matiere</label>
                  <input type="text" name="matiere" class="form-control " style="width: 100%;" placeholder="Nom de la Matiere">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
