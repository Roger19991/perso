...
<body>
  ...
  <div class="album py-5 bg-light">
    ...
    <h2 style="margin-top:-50px;" >Enregistrement des restaurants<h2>
      <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form method="POST" >
              <div class="form-group">
                <input type="text" class="form-control" name="image" placeholder="image du restaurant">
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="nom" placeholder="nom du restaurant">
              </div>
              <div class="form-group">
                <input type="text" name="lien" class="form-control" placeholder="lien de description">
              </div>
              <div class="form-group">
                <textarea name="desc" id="" cols="30" rows="7" class="form-control" placeholder="description du restaurant"></textarea>
              </div>
              <div class="form-group">
                <button class="btn btn-primary" name="valid" style="background-color: rgb(62, 211, 248);"><i   class="icon-check-square-o" ></i></button>
