...
<form method="post"  style="margin-top:120px;">
  <div class="mb-3">
   ...
   <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Identifiant du hotel</label>

    <input type="number" class="form-control" name="idhotel" required>
    <button class="btn btn-primary" name="valide"><i   class="icon-check-square-o"></i></button>
        ...
        <div class="col">
          <div class="card shadow-sm"style="width:50%;">
            ...
            <img src="<?= $hotel->image ?>" style="width:100%; height:50%;">
...
<?php
  ...
  if(isset($_POST['valide']))
  {
    ...
    {
    if(!empty($_POST['idhotel']) AND is_numeric($_POST['idhotel']))
	    {
	    	$idhotel = htmlspecialchars(strip_tags($_POST['idhotel']));
