  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mon registre</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">registre</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Registre des Notes</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        while($t = mysqli_fetch_assoc($r)){
            ...
            echo "<td>".$t["date"]."</td>";
            echo "<td>".$t["note"]."</td>";
            echo "<td>".$t["matiere"]."</td>";
            echo "<td>"."<form action='ing1.php' method='POST'><input type='text' class='d-none' name='registre' value=".$t['id']."><input type='submit' class='btn btn-danger' name='sup' value='supprimer'></form>"."</td>";
            echo "</tr>";
