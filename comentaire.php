    ...
    <section class="content">
      <div class="container-fluid">
        ...
        while($t = mysqli_fetch_assoc($r)){
            ...
            echo "<td>".$t["email"]."</td>";
            echo "<td>".$t["com"]."</td>";
            echo "<td>"."<form action='ing2.php' method='POST'><input type='text' class='d-none' name='commentaire' value=".$t['id']."><input type='submit' class='btn btn-danger' name='sup' value='supprimer'></form>"."</td>";
            echo "</tr>";
